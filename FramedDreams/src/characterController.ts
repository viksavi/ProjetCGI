import { AnimationGroup, TransformNode, ShadowGenerator, Scene, Mesh, UniversalCamera, ArcRotateCamera, Vector3, Quaternion, Ray } from "@babylonjs/core";
...
export class Player extends TransformNode {
    ...
    private _updateFromControls(): void {
        ...
        // Instant Rotation + Position Preservation
        const currentPosition = this.mesh.position.clone(); // Store current position
        //this.mesh.rotationQuaternion = Quaternion.FromEulerAngles(0, angle, 0); // Apply rotation
        this.mesh.rotation.y = angle;
        this.mesh.position.copyFrom(currentPosition); // Restore original position
